"""Regression checks for the orbit-ui-form-trail casebook."""
...
from casebook.harness import assert_expected, orbit_ui_form_trail_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(orbit_ui_form_trail_summary(), assert_expected())
